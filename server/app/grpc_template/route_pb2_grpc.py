...
class UpdateServerRouteStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DevGetDownloadInfo = channel.unary_unary(
                '/server_route.UpdateServerRoute/DevGetDownloadInfo',
        ...
        self.GetServerStatus = channel.unary_unary(
                '/server_route.UpdateServerRoute/GetServerStatus',
...
class UpdateServerRouteServicer(object):
    ...
    def DevGetDownloadInfo(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UpdateServerRouteServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DevGetDownloadInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.DevGetDownloadInfo,
...
class UpdateServerRoute(object):
    ...
    @staticmethod
    def DevGetDownloadInfo(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_route.UpdateServerRoute/DevGetDownloadInfo',
    ...
    def GetServerStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_route.UpdateServerRoute/GetServerStatus',
